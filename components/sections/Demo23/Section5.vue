                    ...
                    <div class="txt-block right-column wow fadeInLeft">
                        ...
                        <div class="txt-box mb-0">
                            ...
                            <ul class="simple-list">
                                ...
                                <li class="list-item">
                                    <p class="mb-0">Cursus purus suscipit vitae cubilia magnis volute egestas</p>
                                </li>
                            </ul>
                            <!-- Link -->
                            <div class="txt-block-tra-link mt-25">
                                <a href="#features-11" class="tra-link ico-20 color--theme"> Automatic workflows <span class="flaticon-next"></span> </a>
                            </div>
                        </div>
                        <!-- END TEXT BOX -->
                    </div>
