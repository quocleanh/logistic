                ...
                <div class="row row-cols-1 row-cols-md-2 rows-3">
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-1 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Tích hợp Dễ Dàng</h6>
                                <p>Sản phẩm của chúng tôi cho phép bạn tích hợp các đơn vị vận chuyển một cách nhanh chóng, từ đó giảm bớt sự phiền toái trong quản lý nhiều đối tác</p>
                            </div>
                        </div>
                    </div>
                    <!-- END FEATURE BOX #1 -->
